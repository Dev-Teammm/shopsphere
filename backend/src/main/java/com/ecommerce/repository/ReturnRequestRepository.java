...
public interface ReturnRequestRepository
       ...
       /**
        * Count return requests by shop ID and status
        */
       long countByShopOrderShopShopIdAndStatus(UUID shopId, ReturnRequest.ReturnStatus status);

       /**
        * Count return requests by shop ID (alternative method if needed)
        */
       long countByShopOrderShopShopId(UUID shopId);
