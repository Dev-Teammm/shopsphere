...
public class OrderResponseDTO {
    ...
    public static class ShopOrderResponse {
        ...
        private String shopCapability; // VISUALIZATION_ONLY, PICKUP_ORDERS, FULL_ECOMMERCE, HYBRID
        private String fulfillmentType; // PICKUP, DELIVERY

        // NEW: Per-shop payment breakdown
        private Integer pointsUsed; // Points applied to this shop
        private BigDecimal pointsValue; // RWF value of points used
        private BigDecimal cardAmount; // Amount paid with card (totalAmount - pointsValue)
        private String paymentStatus; // "POINTS_ONLY", "HYBRID", "CARD_ONLY"
    }
