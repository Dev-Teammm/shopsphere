...
public class PaymentSummaryDTO {
    ...
    public static class ShopSummary {
        ...
        // Shop capability information
        private ShopCapability shopCapability;
        
        // Fulfillment information
        private String fulfillmentType; // "PICKUP" or "DELIVERY"
        private BigDecimal packagingFee; // For pickup orders
        private Boolean requiresFulfillmentChoice; // true for HYBRID shops
    }
}
