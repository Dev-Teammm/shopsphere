...
public class ReturnRequest {
    ...
    private ReturnType returnType = ReturnType.DELIVERY;
    ...
    // Refund screenshot for manual refund verification
    @Column(name = "refund_screenshot_url", length = 1000)
    private String refundScreenshotUrl;

    @Column(name = "refund_screenshot_public_id", length = 255)
    private String refundScreenshotPublicId;
    ...
    public enum ReturnType {
        PICKUP,      // Customer returns to shop
        DELIVERY     // Agent picks up from customer
    }
