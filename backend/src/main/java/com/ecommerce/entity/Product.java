...
@NoArgsConstructor
@AllArgsConstructor
@EqualsAndHashCode(exclude = { "productDetail", "images", "videos", "variants", "reviews", "unit" })
public class Product {
    ...
    /** Whether the product is organic (category-specific). */
    @Column(name = "is_organic")
    private Boolean organic = false;

    /** Unit of measure (e.g. kg, pc). Price is per one unit. */
    @ManyToOne(fetch = FetchType.LAZY)
    ...
    /** Soft delete: when set, product is hidden from listings but kept for order history. */
    ...
    public String getStorageInstructions() {
        return productDetail != null ? productDetail.getStorageInstructions() : null;
    }

    public String getNutritionalInfo() {
        return productDetail != null ? productDetail.getNutritionalInfo() : null;
    }
