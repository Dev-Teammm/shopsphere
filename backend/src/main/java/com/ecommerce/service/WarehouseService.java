...
public interface WarehouseService {
    ...
    // Overloaded method with shopId parameter
    default List<WarehouseDTO> getWarehousesNearLocation(Double latitude, Double longitude, Double radiusKm,
            UUID shopId) {
        return getWarehousesNearLocation(latitude, longitude, radiusKm);
    }

    Page<WarehouseDTO> searchWarehouses(String query, Pageable pageable);

    Page<WarehouseDTO> searchWarehouses(String query, UUID shopId, Pageable pageable);
