...
public class EmailServiceImpl implements EmailService {
    ...
    @Value("${app.frontend.url:https://shopsphere-new.vercel.app/}")
    private String frontendUrl;

    @Value("${app.frontend.admin.url:https://shopsphere-mng.vercel.app}")
    ...
    public void sendNewUserInvitationEmail(String toEmail, String firstName, String lastName,
        ...
        try {
            ...
            String invitationUrl = String.format("%s/admin-invitation/accept?token=%s", frontendAdminUrl,
                    invitationToken);
    ...
    public void sendExistingUserRoleUpdateEmail(String toEmail, String firstName, String lastName,
            String invitationToken, String invitedByName, String assignedRole,
            String invitationMessage, String department,
            String position, String expiresAt) {
        ...
        try {
            ...
            log.info("Role update email with invitation link sent successfully to: {}", toEmail);
    ...
    private String buildExistingUserRoleUpdateEmailBody(String firstName, String lastName,
            String invitationToken, String invitedByName, String assignedRole,
            String invitationMessage, String department,
            String position, String expiresAt, String invitationUrl) {
        ...
        body.append("To accept this invitation and join the shop, please click the following link:\n");
        body.append(invitationUrl).append("\n\n");

        body.append("This invitation will expire on: ").append(expiresAt).append("\n\n");

        body.append("Important Notes:\n");
        body.append("- Since you already have an account, you can use your existing credentials\n");
        body.append("- This invitation link can only be used once\n\n");
