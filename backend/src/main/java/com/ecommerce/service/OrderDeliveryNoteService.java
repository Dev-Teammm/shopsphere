...
public interface OrderDeliveryNoteService {
    ...
    /**
     * Get all notes for a specific shop order
     * @param shopOrderId The shop order ID
     * @param pageable Pagination information
     * @param agentEmail The agent email for validation (null for ADMIN/EMPLOYEE)
     * @return Page of notes
     */
    Page<OrderDeliveryNoteDTO> getNotesForOrder(Long shopOrderId, Pageable pageable, String agentEmail);
     ...
     * @return Page of notes
     */
    Page<OrderDeliveryNoteDTO> getAllNotesForDeliveryGroup(Long groupId, Pageable pageable, String agentEmail);
