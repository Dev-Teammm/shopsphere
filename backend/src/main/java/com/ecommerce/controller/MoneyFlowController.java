...
public class MoneyFlowController {
    ...
    @Operation(summary = "Get money flow data with automatic aggregation", 
               description = "Retrieve money flow data between two dates. The system automatically determines the best aggregation granularity based on the time range. ADMIN, EMPLOYEE, and VENDOR roles can access this endpoint.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Get all transactions within a date range", 
               description = "Retrieve all individual money flow transactions between two dates without aggregation. ADMIN, EMPLOYEE, and VENDOR roles can access this endpoint.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Get current account balance", 
               description = "Retrieve the current account balance based on the latest transaction. VENDOR role can access for shop analytics.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Get a specific money flow transaction by ID", 
               description = "Retrieve details of a specific money flow transaction. ADMIN, EMPLOYEE, and VENDOR roles can access this endpoint.")
    @ApiResponses(value = {
