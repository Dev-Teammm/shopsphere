...
public class AuthServiceImpl implements AuthService {
    ...
    public SignupResponseDTO registerUser(UserRegistrationDTO registrationDTO) {
        ...
        return new SignupResponseDTO(
                ...
                savedUser.getId(),
                0,
                "Welcome bonus points are not yet available.");
    }
    ...
    private void validatePhoneNumber(String phoneNumber) {
        ...
        if (digitsOnly.startsWith("0") && digitsOnly.length() != 10 && digitsOnly.length() != 9) {
            throw new CustomException("Local phone number format is invalid (should be 9-10 digits starting with 0)");
        }
    }
}
